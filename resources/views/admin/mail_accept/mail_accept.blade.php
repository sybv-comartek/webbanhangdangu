...
<html>
<head>
	<title>Mail Gửi Khách Hàng</title>
</head>
<body>
<div class="col-md-12">
	...
	<h3 style="text-align: center;"> Đơn hàng của bạn đã được giao thành công</h3>
...
<p>Để xem lại lịch sử đơn hàng. Vui lòng truy cập <a href="{{URL::to('http://localhost/webbanhanglaravel/history-checkout')}}"></a></p>
