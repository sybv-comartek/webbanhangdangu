                             ...
                             <div class="col-sm-4">
                                ...
                                <form>
                                    <div id="slider-range"></div>
                                     ...
                                     <input type="submit" name="filter_money" value="Lọc giá" class="btn btn-sm btn-default">
                                </form>
                            </div>
                        </div> 
                             ...
                             <div class="product-image-wrapper">
                                ...
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <a href="{{URL::to('/chi-tiet/'.$product->product_slug)}}">
                                                <img width="300" height="300" src="{{URL::to('public/uploads/product/'.$product->product_image)}}" alt="" />
